    ...
    return (
        <>
            ...
            <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                <div class="px-4 pt-8">
                    <p class="text-xl font-medium">Détails du panier</p>
                    <p class="text-gray-400">Regardez vos articles et choissisez votre moyen de paiement</p>
                ...
                <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    <p class="text-xl font-medium">Information paiement</p>
                    <div class="mt-4">
                        <p class="text-sm font-medium text-gray-900">Choisissez votre méthode de paiement</p>
                        <div>
                            ...
                            <label for="creditCard">Carte Bancaire</label>
                        </div>
                    </div>

                    {paymentMethod === 'Credit Card' && (
                        <>
                            <label for="card-holder" class="mt-4 mb-2 block text-sm font-medium">Porte Carte</label>
                            <div class="relative">
                                <input type="text" id="card-holder" name="card-holder" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Votre nom entier" />
                            ...
                            <label for="card-no" class="mt-4 mb-2 block text-sm font-medium">Détails cartes</label>
                            <div class="flex">
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900">Prix articles</p>
                    ...
                    <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Payer</button>
                </div>
            </div>
